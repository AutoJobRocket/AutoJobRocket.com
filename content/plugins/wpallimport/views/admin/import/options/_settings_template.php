		...
		<fieldset class="optionsset">
			...
			<p>
				<div class="input pl17">
					<label for="save_import_as" style="margin-right:17px;"><?php _e('Friendly Name:','pmxi_plugin');?></label> <input type="text" name="friendly_name" title="<?php _e('Save friendly name...', 'pmxi_plugin') ?>" style="vertical-align:middle; font-size:11px; background:#fff !important;" value="<?php echo esc_attr($post['friendly_name']) ?>" />
				</div>
			</p>
			<p>
				<div class="input">
