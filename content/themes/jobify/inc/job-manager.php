...
function jobify_job_archives_query( $query ) {
	...
	if ( is_tax( 'job_listing_category' ) || is_tax( 'job_listing_region' ) || is_tax( 'job_listing_type' ) || is_tax( 'job_listing_tag' ) ) {
...
function jobify_job_archives() {
	...
	if ( ! in_array( $taxonomy->taxonomy, array( 'job_listing_category', 'job_listing_region', 'job_listing_type', 'job_listing_tag' ) ) )
		return;
...
function jobify_the_company_description( $before = '', $after = '', $echo = true ) {
	...
	$company_description = esc_attr( strip_tags( $company_description ) );
